...
export const MODELS_CONFIG: ModelConfig[] =[
  ...
  { section: 'box', models_array: [{ model: 'cube', camera_position: [0, 0, 3], camera_lookat: [0, 1, 0], xyz: [0, 0, 0] }, { model: 'planet', camera_position: [0, 0, 3], camera_lookat: [0, 1, 0], xyz: [0, 0, 0] }] },
